          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box">
                <h4 class="page-title text-primary">My application status</h4>
                <p class="lead">The system will submit an update request on your behalf and this session will be ended. Within an hour, you will receive an email update of your application status.</p>
                <p class="lead">However, for security reason, the system did not store your login email address. Please enter your login email address below to receive the update.</p>
              </div>
            </div>
          </div>     
          <!-- end page title --> 
                   ...
                   <?php $show = TRUE;
                    if (isset($_SESSION['success'])) {?>
                      <div class="alert alert-success"> 
                        <h4 class="page-title text-primary"><?php echo $_SESSION['success']; ?></h4>
                      </div>
                   <?php $show = FALSE;
                   } else if (isset($_SESSION['error'])) {?>
                     <div class="alert alert-danger">
                      <h4 class="page-title text-primary"><?php echo $_SESSION['error']; ?></h4>
                    </div>
                     <?php 
                   }?>
