...
<head>
  <meta charset="utf-8" />
  <title>TPG - current status - NOT student - file upload</title>
          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box">
                <h4 class="page-title">Supporting documents upload</h4>
                <p>This page is for applicant already completed at least one Bachelor degree and received graduation certificate, and currently not engaging as a student in any institution.</p>
                <p>Please follow instructions below to upload all necessary supporting documents. If you are currently studying for a Bachelor or higher degree, please click on the other link on the left panel under Official documents, this page is not for you.
                </p>
                          ...
                          <ul class="list-group">
                            <li class="list-group-item">
                              ...
                              <div class="row">
                                ...
                                <div class="col-4 mb-4"> <!-- file upload -->
                                  <form action="fileupload/validate" method="post">
