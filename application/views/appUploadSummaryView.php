...
<head>
  <meta charset="utf-8" />
  <title>TPG - check upload summary</title>
          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box">
                <h4 class="page-title text-primary">My upload summary</h4>
                <p class="lead">The system is going to email the file upload summary to you, and this session will be ended.</p>
                <p class="lead">However, for security reason, the system did not store your login email address. Please enter your login email address below to receive the file upload summary.</p>
              </div>
            </div>
          </div>     
          <!-- end page title --> 
