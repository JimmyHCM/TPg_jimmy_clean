...
<!--<div class="container-fluid">-->
    ...
    <div class="left-side-menu">
      ...
      <div class="slimscroll-menu">
        ...
        <ul class="metismenu side-nav">
          ...
          <li class="side-nav-item">
            <a href=" https://engg.hku.hk/Portals/0/TPG/faq.pdf" target="_blank" class="side-nav-link">
              ...
              <ul>
                ...
                <li>pdf
                  <ul>
                    ...
                    <li>secured / protected pdf is not allowed</li>
                    <li>max size: 3MB</li>
                  </ul>
                </li>
              </ul>
              ...
              <ul class="nav nav-pills bg-light" role="tablist">
                  ...
                  <li class="nav-item">
                    <a href="#info-2" data-toggle="tab" role="tab" aria-expanded="true" class="nav-link active">
                      <span class="d-none d-lg-block">Academic studies<br/>(please start with the most recent one)</span>
                    </a>
                  </li>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <ul class="nav nav-pills bg-light" role="tablist">
                        ...
                        <li class="nav-item">
                          <a href="#info-20" data-toggle="tab" role="tab" aria-expanded="true" class="nav-link active">
                            <span class="d-none d-lg-block">Institution #1</span>  
                          </a>
                        </li>
                        <?php } ?>
                        <?php for ($qset = 1; $qset <= MAX_filePNO; $qset++) { ?>
                          <?php if ($_SESSION['currentStatus'] == '1') $showQ = 1 + $qset; else $showQ = $qset; ?>
                          <li class="nav-item">
                            <a href="#info-2<?php echo $qset; ?>" data-toggle="tab" role="tab" aria-expanded="<?php if ($_SESSION['currentStatus'] == '2' && $qset == 1) echo 'true'; else echo 'false' ?>" class="nav-link <?php if ($_SESSION['currentStatus'] == '2' && $qset == 1) echo 'active'; ?> <?php if ($qset > $Pno) echo 'disabled'; ?>">
                              
                                <span class="d-none d-lg-block <?php if ($qset > $Pno) echo 'text-muted'; ?>">Institution #<?php echo $showQ; ?></span>
                      ...
                      <div class="tab-content">
                        ...
                        <?php if ($_SESSION['currentStatus'] == '1') { ?>
                        <div class="tab-pane show active" id="info-20">
                          <form method="post" action="<?php echo base_url().'upload/uploadAll'; ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-left">
                              <div class="row">
                                <div class="col-8">
                                  <label for="title0"><h5>Institution and degree to be obtained (max 15 characters, as a reference tag, short form is ok. e.g. BEng_PolyU)</h5></label>
                                </div>
                                <div class="col-4">
                              ...
                              <div class="row">
                                ...
                                <select name="country" id="country0" onchange="updateText()">
                                  <option value="" selected="selected">Please select country of the institution</option>
                                  ...
                                  <?php if (UPLOAD_ITEMS[$i][1] != "") { ?>
                                    <div class="row">
                                      <div class="col-8">
                                        <div class="row">
                                        <div class="col-12">
                                          <strong id='<?php echo UPLOAD_ITEMS[$i][0]; ?>'><?php echo UPLOAD_ITEMS[$i][1]; ?></strong>
                        ...
                        <?php for ($qq = 0; $qq < $Pno; $qq++) { ?>
                          <?php $qset = $qq+1; ?>
                          <div class="tab-pane <?php if ($_SESSION['currentStatus'] == '2' && $qset == 1)  echo 'show active'; ?>" id="info-2<?php echo $qset; ?>">
                            <form method="post" action="<?php echo base_url().'upload/uploadAll'; ?>" enctype="multipart/form-data">
                              ...
                              <div class="form-group text-left">
                                ...
                                <!-- new -->
                                <div class="row">
                                  Testing <?php echo $qset; ?> <br/>
                                  <label for="country">Country</label>
                                  <select name="country" id='<?php echo "country".$qset; ?>' onchange="updateText()">
                                    <option value="" selected="selected">Please select country of the institution</option>
                                    <option value="china">China</option>
                                    <option value="hk">HK</option>
                                    <option value="uk">UK</option>
                                  ...
                                  <li class="list-group-item">
                                    <div class="row">
                                      <div class="col-8">
                                        <div class="row">
                                          <div class="col-12">
                                            <h5 id='<?php echo UPLOAD_ITEMS[$i][0]; ?>'><?php echo UPLOAD_ITEMS[$i][1]; ?>
                                              <?php if (UPLOAD_ITEMS[$i][2] != "") { ?>
  ...
  var labelC1 = document.getElementById("fileC1");
  var labelP10 = document.getElementById("fileP10");
  var labelP20 = document.getElementById("fileP20");
  function updateText()
  {
    var country0 = document.getElementById("country0");
    var country1 = document.getElementById("country1");
    var country2 = document.getElementById("country2");
    if (country0.value == 'china')
      labelC1.innerHTML = 'fileC1: new name for official transcript';
    else
      labelC1.innerHTML = 'back to old name for official transcript';

    if (country1.value == 'china')
      labelP10.innerHTML = "fileP10: new name for official transcript ";
    if (country2.value == 'china')
      labelP20.innerHTML = "fileP20: new name for official transcript ";
  }
